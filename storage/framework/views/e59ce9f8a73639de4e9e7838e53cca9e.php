    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">Welcome <?php echo e(Session::get('name')); ?>!</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="card dash-widget bg-primary">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="fa fa-cubes"></i></span>
                            <div class="dash-widget-info">
                               <span style="color: white;">Total Projects</span> <h3 style="color: white;"><?php echo e($totalProjects); ?></h3>
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 col-xl-3 mb-4">
                    <div class="card dash-widget bg-success">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="fa fa-usd"></i></span>
                            <div class="dash-widget-info">
                                 <span style="color: white;">Total Clients</span><h3 style="color: white;"><?php echo e($totalClients); ?></h3>
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 col-xl-3 mb-4">
                    <div class="card dash-widget bg-info">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="fa fa-diamond"></i></span>
                            <div class="dash-widget-info">
                            <span style="color: white;">Total Tasks</span>   <h3 style="color: white;"><?php echo e($totalTasks); ?></h3> 
    ...
    <div class="card dash-widget bg-secondary">
        <div class="card-body"> <span class="dash-widget-icon"><i class="fa fa-user"></i></span>
            <div class="dash-widget-info">
                ...
                <h3 style="color: white;"><?php echo e($todayAbsentCount); ?></h3> 
...
<div class="col-md-4 col-sm-4 col-lg-4 col-xl-3 mb-4">
                    <div class="card dash-widget bg-warning">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="fa fa-user"></i></span>
                            <div class="dash-widget-info">
                              <span style="color: white;">Total Employees</span>   <h3 style="color: white;"><?php echo e($totalEmployees); ?></h3> 
...
<table class="table table-dark">
    <tr>
        <th colspan="35">
            ...
            <span style="float: right"><?php echo e(date('F')); ?></span>
        </th>
    </tr>
    ...
    <tr>
        ...
        <?php for($day = 1; $day <= 31; $day++): ?>
            <th><?php echo e(\Carbon\Carbon::create(null, null, $day)->format('D d')); ?></th>
        <?php endfor; ?>
    </tr>
    ...
    <?php $__currentLoopData = $attendanceData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(!in_array($employeeName, $displayedNames)): ?>
            <tr>
                <td><?php echo e($employeeName); ?></td>
                <?php for($currentDay = 1; $currentDay <= $daysInMonth; $currentDay++): ?>
                    <td>
                        <?php 
                            $hasStatus = false; 
                            $statusIcon = ''; 
                        ...
                        <?php echo $hasStatus ? $statusIcon : '-'; ?>

                    </td>
                <?php endfor; ?>
            </tr>
            <?php $displayedNames[] = $employeeName; ?>
        <?php endif; ?>
...
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_project\projectmain\resources\views/Admin/adminhome.blade.php ENDPATH**/ ?>