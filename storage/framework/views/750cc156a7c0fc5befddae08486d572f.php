        ...
        <div class="card shadow mt-3">
            <div class="card-header bg-dark text-white">
                ...
                <div class="d-flex justify-content-end">
                    <a href="<?php echo e(url('/taskadd')); ?>" class="btn btn-primary me-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <?php $__currentLoopData = $approvedClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="projectRow" data-payment="<?php echo e($client->payment_method); ?>" data-status="<?php echo e($client->client_project_status); ?>">
...
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_project\projectmain\resources\views/admin/clientreport.blade.php ENDPATH**/ ?>