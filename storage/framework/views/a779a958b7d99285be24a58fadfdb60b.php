...
<div class="card shadow">
    ...
    <div class="card-body">
                    ...
                    <div class="row p-4">
                        <form  class="row g-3" action="<?php echo e(url('/home/clientstore')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_project\projectmain\resources\views/Admin/clientadd.blade.php ENDPATH**/ ?>