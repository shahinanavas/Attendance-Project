...
<div class="card shadow">
    <div class="card-header bg-dark text-white">
        ...
        <div class="d-flex justify-content-end">
                        <a href="<?php echo e(url('/home/clientadd')); ?>" class="btn btn-primary">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($client->project_type); ?></td>
                                        <td><?php echo e($client->project_type_detail); ?></td>
                                        <td><?php echo e($client->client_project_status); ?></td>
                                        <td><?php echo e($client->quotation_sent); ?></td>
                                        <td>
                                            <?php if($client->quotation_file): ?>
                                                <a href="<?php echo e(asset('storage/'.$client->quotation_file)); ?>" target="_blank">View File</a>
                                            <?php else: ?>
                                                No File
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($client->quotation_status); ?></td>
                                        <td><?php echo e($client->total_amount); ?></td>
                                        <td><?php echo e($client->amount_paid); ?></td>
                                        <td><?php echo e($client->balance); ?></td>
                                        <td>
                                            <a href="<?php echo e(url('/home/clientedit/'.$client->id)); ?>" class="btn btn-success">
                                        ...
                                        <td>
    <form action="<?php echo e(route('client.delete', ['id' => $client->id])); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_project\projectmain\resources\views/Admin/clientview.blade.php ENDPATH**/ ?>